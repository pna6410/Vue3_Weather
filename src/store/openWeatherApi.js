...
export default {
    ...
    actions: {
        // actions 부분에서 mutations처럼 state를 바로 불러올 순 없고, 
        // context라는 객체데이터를 가져와서, context를 참조하여 데이터를 불러온다.
        // context 안에는 state, getters, mutations를 활용할 수 있는 내용이 들어있다.
        // mutations를 불러오기 위해서는 context.mutations가 아니라 context.commit('뮤테이션 이름', payload)형식으로 호출해야 한다.
        // ------------------------------------------------------------------------------------------
        // searchData({ context }) {
